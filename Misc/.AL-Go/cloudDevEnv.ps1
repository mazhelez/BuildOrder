...
$webClient.DownloadFile('https://raw.githubusercontent.com/mazhelez/AL-Go/add-project-name/Actions/Github-Helper.psm1', $GitHubHelperPath)
Write-Host "Downloading AL-Go Helper script"
$ALGoHelperPath = "$([System.IO.Path]::GetTempFileName()).ps1"
$webClient.DownloadFile('https://raw.githubusercontent.com/mazhelez/AL-Go/add-project-name/Actions/AL-Go-Helper.ps1', $ALGoHelperPath)
