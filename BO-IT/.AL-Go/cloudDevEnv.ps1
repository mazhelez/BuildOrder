...
$webClient.DownloadFile('https://raw.githubusercontent.com/mazhelez/AL-Go/fetch-artifacts-per-build-mode/Actions/Github-Helper.psm1', $GitHubHelperPath)
Write-Host "Downloading AL-Go Helper script"
$ALGoHelperPath = "$([System.IO.Path]::GetTempFileName()).ps1"
$webClient.DownloadFile('https://raw.githubusercontent.com/mazhelez/AL-Go/fetch-artifacts-per-build-mode/Actions/AL-Go-Helper.ps1', $ALGoHelperPath)
