...
$webClient.DownloadFile('https://raw.githubusercontent.com/freddydk/AL-Go/Actions/Settings3/Github-Helper.psm1', $GitHubHelperPath)
Write-Host "Downloading AL-Go Helper script"
$ALGoHelperPath = "$([System.IO.Path]::GetTempFileName()).ps1"
$webClient.DownloadFile('https://raw.githubusercontent.com/freddydk/AL-Go/Actions/Settings3/AL-Go-Helper.ps1', $ALGoHelperPath)
